...
const PrimaryInfo: FunctionComponent = () => {
  ...
  return (
    <div className={style.primaryInfo}>
      ...
      <img src={photo} alt="User avatar" className={style.avatar}/>
      
      {isOwner && <label htmlFor="upload-button" className={classNames(buttonStyle.button, style.scale)}>Завантажити фото
      ...
      <button className={classNames(buttonStyle.button, buttonStyle.shadow)}>
