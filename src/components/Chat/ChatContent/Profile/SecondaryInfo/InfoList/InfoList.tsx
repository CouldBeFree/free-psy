...
const InfoList: FunctionComponent<InfoListProps> = ({setEditMode, editMode}: InfoListProps) => {
  ...
  return (
    <> 
      {isOwner && <button onClick={() => setEditMode(!editMode)} className={classNames(buttonStyle.button, buttonStyle.flexEnd)} disabled={isSubmitting}>
      ...
      <div className={style.infoList}>
        ...
        <>
          <div className={style.infoLine}>
            ...
            <span className={style.info}>{name?.split(" ")[1]}</span>
          </div>
          <div className={style.infoLine}>
            <span className={style.typeInfo}>Прізвище:</span>
            <span className={style.info}>{name?.split(" ")[0]}</span>
          </div>
          <div className={style.infoLine}>
            <span className={style.typeInfo}>Освіта:</span>
            <span className={style.info}>{education ? education : "Інформація відсутня"}</span>
          </div>
          <div className={style.infoLine}>
            <span className={style.typeInfo}>Напрям психотерапії:</span>
            <span  className={style.info}>{approaches ? approaches : "Інформація відсутня"}</span>
          </div>
          <div className={style.infoLine}>
            <span className={style.typeInfo}>Працюю з:</span>
            <span  className={style.info}>{workWith ? workWith : "Інформація відсутня"}</span>
          </div>
          <div className={style.infoLine}>
            <span className={style.typeInfo}>Про себе:</span>
            <span  className={style.info}>{aboutMe ? aboutMe : "Інформація відсутня"}</span>
          </div>
        </> : 
          <div className={style.infoLine}>
        ...
        <div className={style.infoLine}>
          ...
          <span className={style.info}>{contacts ? contacts : "Інформація відсутня"}</span>
        </div>
      </div>
    </>
  )
