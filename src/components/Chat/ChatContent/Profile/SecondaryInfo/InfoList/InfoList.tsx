...
const InfoList: FunctionComponent<InfoListProps> = ({setEditMode, editMode}: InfoListProps) => {
  ...
  return (
    <>
      <button onClick={() => setEditMode(!editMode)} className={classNames(buttonStyle.button, buttonStyle.shadow, buttonStyle.editor)}>
        ...
        <span className={buttonStyle.buttonText}>Редагувати</span>
      </button>
