...
const InfoListForm: FunctionComponent<InfoListProps> = ({setEditMode, editMode}: InfoListProps) => {
  ...
  const onInfoSave = (formData: PrimaryInfoFormData) => {
  ...
  return (
      <Form onSubmit={onInfoSave} render={({ handleSubmit }) => (
        <form className={style.form} onSubmit={handleSubmit}>
          ...
          <button className={classNames(buttonStyle.button, buttonStyle.shadow, buttonStyle.editor)}>
          ...
          <div className={style.formWrapper}>
            <div className={style.inputBlock}>
              ...
              <Field className={style.field} name="education" component="textarea" placeholder={education} />
            </div>
            <div className={style.inputBlock}>
              <span className={style.typeInfo}>Напрям психотерапії:</span>
              <Field className={style.field} name="approaches" component="textarea" placeholder={approaches} />
            </div>
            <div className={style.inputBlock}>
              <span className={style.typeInfo}>Працюю з:</span>
              <Field className={style.field} name="workWith" component="textarea" placeholder={workWith} />
            </div>
            <div className={style.inputBlock}>
              <span className={style.typeInfo}>Про себе:</span>
              <Field className={style.field} name="aboutMe" component="textarea" placeholder={aboutMe} />
            </div>
            <div className={style.inputBlock}>
              <span className={style.typeInfo}>Контакти:</span>
              <Field className={style.field} name="contacts" component="textarea" placeholder={contacts} />
            </div>
          </div>
